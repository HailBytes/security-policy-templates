# Security Framework Cross-Reference Mapping
...
> **How to use:** Find your policy template in the left column. The mapped controls in each framework column represent areas addressed by that template. Use this table to populate compliance matrices, audit evidence packages, or gap assessments.
...
### 9. Router and Switch Security Policy
...
### 12. Remote Work and BYOD Policy *(new)*
...
### 13. Data Classification Policy *(new)*
...
### 14. Vendor and Third-Party Risk Policy *(new)*
...
### 16. Vulnerability and Patch Management Policy *(new)*
...
### 17. Change Management Policy *(new)*
...
Use the table below to identify which frameworks your organization is targeting and which policy templates address each required control.

| Target Framework | Control ID | Control Name | Policy Template(s) | Status | Gap / Notes |
|----------------|-----------|-------------|-------------------|--------|------------|
| CIS v8 | CIS 3 | Data Protection | Data Classification Policy | | |
| CIS v8 | CIS 5 | Account Management | Password Protection, Remote Work | | |
| CIS v8 | CIS 6 | Access Control Management | Password Protection, Remote Work | | |
| CIS v8 | CIS 7 | Continuous Vulnerability Management | Vulnerability Management Policy | | |
| CIS v8 | CIS 11 | Data Recovery | Disaster Recovery Policy | | |
| CIS v8 | CIS 14 | Security Awareness | Training templates | | |
| CIS v8 | CIS 15 | Service Provider Management | Vendor Risk Policy | | |
| CIS v8 | CIS 17 | Incident Response | Incident Response, Breach Response | | |
| ISO 27001 | A.5.12 | Data Classification | Data Classification Policy | | |
| ISO 27001 | A.5.19–5.22 | Supplier Relationships | Vendor Risk Policy | | |
| ISO 27001 | A.5.23 | Cloud Services | Cloud Security Policy | | |
...
| SOC 2 | CC9 | Risk Mitigation | Vendor Risk, Data Classification | | |
