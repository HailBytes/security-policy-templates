...
### 1.1 Approved AI Tools *(NIST CSF: ID.AM-02, GV.PO-01)*
...
### 1.2 Data Classification Limits for AI Tools *(NIST CSF: PR.DS-01, PR.DS-05)*
...
### 1.3 Prohibited AI Uses *(NIST CSF: GV.PO-01, PR.DS-05)*
...
### 1.4 Approved MCP Servers and AI Integrations *(NIST CSF: ID.AM-02, GV.SC-01)*
...
### 1.5 MCP Server Security Assessment *(NIST CSF: GV.SC-03, GV.SC-07)*
...
### 1.6 Principle of Least Privilege for AI Agents *(NIST CSF: PR.AA-05, PR.AA-02)*
...
### 1.7 Prompt Injection Risk Management *(NIST CSF: ID.RA-01, PR.DS-05)*
...
### 1.8 AI Agent Monitoring and Logging *(NIST CSF: DE.CM-01, DE.AE-03)*
...
### 1.9 AI Agent Supply Chain *(NIST CSF: GV.SC-07, PR.DS-06)*
...
### 1.10 Personal Data and AI *(NIST CSF: PR.DS-01, PR.DS-05)*
...
### 1.11 Intellectual Property and AI Output *(NIST CSF: GV.PO-01)*
...
### 1.12 Internally Developed AI Models *(NIST CSF: PR.PS-01, ID.RA-01)*
...
### 1.13 AI in Automated Decision-Making *(NIST CSF: GV.PO-01, GV.OC-03)*
...
### 1.14 AI Security Training *(NIST CSF: PR.AT-01, PR.AT-02)*
...
### 1.15 Incident Reporting *(NIST CSF: RS.CO-02, DE.AE-01)*
...
### 1.16 Policy Acknowledgment *(NIST CSF: PR.AT-01)*
...
## References
- NIST CSF 2.0: ID.AM (Asset Management), GV.PO (Governance), GV.SC (Supply Chain), PR.DS (Data Security), PR.AA (Access Control), DE.CM (Continuous Monitoring)
