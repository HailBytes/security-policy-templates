...
### 2.1 Classification Tiers *(NIST CSF: ID.AM-05, PR.DS-01)*
...
### 2.2 Default Classification *(NIST CSF: ID.AM-05)*
...
### 2.3 Data Owner Responsibilities *(NIST CSF: ID.AM-05, GV.PO-01)*
...
### 2.4 Data Custodian Responsibilities *(NIST CSF: PR.DS-01, PR.AA-05)*
...
### 2.5 Employee Responsibilities *(NIST CSF: PR.AT-01)*
...
### 2.6 Public Data *(NIST CSF: PR.DS-01)*
...
### 2.7 Internal Data *(NIST CSF: PR.DS-01, PR.DS-02)*
...
### 2.8 Confidential Data *(NIST CSF: PR.DS-01, PR.DS-02, PR.AA-05)*
...
### 2.9 Restricted Data *(NIST CSF: PR.DS-01, PR.DS-02, PR.AA-05, PR.DS-05)*
...
### 2.10 Data Retention *(NIST CSF: PR.DS-03, PR.DS-09)*
...
### 2.11 Data Disposal *(NIST CSF: PR.DS-03)*
...
### 2.12 Cloud and Third-Party Storage *(NIST CSF: PR.DS-01, GV.SC-05)*
...
## References
- NIST CSF 2.0: ID.AM (Asset Management), PR.DS (Data Security), PR.AA (Access Control)
