...
### 2.1 Mandatory MFA Coverage *(NIST CSF: PR.AC-7, PR.AC-1)*
...
### 2.2 Approved MFA Methods *(NIST CSF: PR.AC-7)*
...
### 2.3 Accounts Exempt from MFA *(NIST CSF: PR.AC-4, PR.IP-1)*
...
### 2.4 Enrollment Requirements *(NIST CSF: PR.AC-1, PR.AT-1)*
...
### 2.5 Recovery and Lost-Device Procedures *(NIST CSF: PR.AC-4, PR.AC-1)*
...
### 2.6 MFA for Service Accounts and APIs *(NIST CSF: PR.AC-1, PR.AC-5)*
...
### 2.7 Technical Controls *(NIST CSF: PR.AC-7, PR.PT-1)*
...
### 2.8 Phishing-Resistant MFA for High-Risk Roles *(NIST CSF: PR.AC-7, PR.AC-4)*
...
## References
- NIST CSF v1.1: PR.AC (Access Control), PR.AT (Awareness and Training), PR.PT (Protective Technology), DE.CM (Security Continuous Monitoring)
