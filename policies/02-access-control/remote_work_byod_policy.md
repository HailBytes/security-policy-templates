...
### 3.1 Approved Work Locations *(NIST CSF: PR.AA-03, PR.DS-02)*
...
### 3.2 Network Security *(NIST CSF: PR.AA-03, PR.AA-07)*
...
### 3.3 VPN and Authentication *(NIST CSF: PR.AA-03, PR.AA-03)*
...
### 3.4 Physical Security of Work Environment *(NIST CSF: PR.AA-06, PR.DS-01)*
...
### 3.5 Device Eligibility *(NIST CSF: ID.AM-01, PR.AA-01)*
...
### 3.6 Required Security Controls on Personal Devices *(NIST CSF: PR.AA-01, PR.DS-01)*
...
### 3.7 Acceptable Use on Personal Devices *(NIST CSF: PR.AT-01, PR.DS-05)*
...
### 3.8 Lost or Stolen Devices *(NIST CSF: RS.CO-02, PR.PS-01)*
...
### 3.9 Approved Applications *(NIST CSF: PR.DS-01, PR.PS-01)*
...
### 3.10 Data Handling *(NIST CSF: PR.DS-01, PR.DS-02, PR.DS-05)*
...
### 3.11 Monitoring and Auditing *(NIST CSF: DE.CM-01, DE.CM-01, DE.AE-03)*
...
### 3.12 Training and Acknowledgment *(NIST CSF: PR.AT-01, PR.AT-02)*
...
### 3.13 Termination and Offboarding *(NIST CSF: PR.AA-01, GV.RR-04)*
...
## References
- NIST CSF 2.0: PR.AA (Access Control), PR.DS (Data Security), PR.AT (Awareness and Training), DE.CM (Security Continuous Monitoring)
