...
### 5.1 Approved Cloud Services *(NIST CSF: ID.AM-02, GV.PO-01)*
...
### 5.2 Cloud Procurement Requirements *(NIST CSF: GV.SC-05, GV.SC-07)*
...
### 5.3 Cloud Access Controls *(NIST CSF: PR.AA-01, PR.AA-03, PR.AA-05)*
...
### 5.4 Privileged Access in Cloud *(NIST CSF: PR.AA-05, PR.AA-02)*
...
### 5.5 Data Encryption *(NIST CSF: PR.DS-01, PR.DS-02)*
...
### 5.6 Data Residency and Sovereignty *(NIST CSF: PR.DS-01, GV.OC-03)*
...
### 5.7 Data Backup and Recovery *(NIST CSF: PR.DS-04, RC.RP-01)*
...
### 5.8 Secure Configuration Baselines *(NIST CSF: PR.PS-01, PR.PS-01)*
...
### 5.9 Network Segmentation *(NIST CSF: PR.IR-01, PR.AA-07)*
...
### 5.10 Infrastructure as Code (IaC) Security *(NIST CSF: PR.PS-01, PR.DS-06)*
...
### 5.11 Cloud Logging and Monitoring *(NIST CSF: DE.CM-01, DE.CM-01, DE.AE-03)*
...
### 5.12 Cloud Security Incident Response *(NIST CSF: RS.MA-01, RS.CO-02)*
...
## References
- NIST CSF 2.0: ID.AM, PR.AA, PR.DS, DE.CM
